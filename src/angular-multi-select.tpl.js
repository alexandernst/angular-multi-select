	...
	$templateCache.put('angular-multi-select.tpl', `
		...
		<div class="ams-container ng-cloak" ng-show="open">
			...
			<div class="ams-helpers">
				<div class="selects">
					<button class="all ams-btn" type="button" ng-click="amse.check_all()" ng-hide="hide_helpers.indexOf('check_all') > -1">Check all</button>
					<button class="none ams-btn" type="button" ng-click="amse.uncheck_all()" ng-hide="hide_helpers.indexOf('check_none') > -1">Check none</button>
				</div>

				<div class="resets">
					<button class="reset ams-btn" type="button" ng-click="reset()" ng-hide="hide_helpers.indexOf('reset') > -1">Reset data</button>
				</div>
			</div>
			...
			<div class="ams-search" ng-show="search_field !== null">
				...
				<button class="clear ams-btn" type="button" name="clear" ng-click="search = ''"></button>
			</div>
