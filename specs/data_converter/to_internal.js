...
var to_internal_data_1_after = [
	{ text: 'A', value: 'a', id: 1,  $ams_order: 1,  $ams_parents_id: [],               $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 0, open: false, $ams_tree_visibility: true,  checked: false, $ams_checked_children: 0 },
	{ text: 'B', value: 'b', id: 2,  $ams_order: 2,  $ams_parents_id: [],               $ams_children_nodes: 0, $ams_children_leafs: 1, $ams_level: 0, open: true,  $ams_tree_visibility: true,  checked: 1,     $ams_checked_children: 1 },
	{ text: 'C', value: 'c', id: 3,  $ams_order: 3,  $ams_parents_id: [2],              $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: true,  checked: true,  $ams_checked_children: 0 },
	{ text: 'D', value: 'd', id: 4,  $ams_order: 4,  $ams_parents_id: [],               $ams_children_nodes: 0, $ams_children_leafs: 2, $ams_level: 0, open: false, $ams_tree_visibility: true,  checked: 0,     $ams_checked_children: 1 },
	{ text: 'E', value: 'e', id: 5,  $ams_order: 5,  $ams_parents_id: [4],              $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: false, checked: false, $ams_checked_children: 0 },
	{ text: 'F', value: 'f', id: 6,  $ams_order: 6,  $ams_parents_id: [4],              $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: false, checked: true,  $ams_checked_children: 0 },
	{ text: 'G', value: 'g', id: 7,  $ams_order: 7,  $ams_parents_id: [],               $ams_children_nodes: 1, $ams_children_leafs: 5, $ams_level: 0, open: false, $ams_tree_visibility: true,  checked: -1,    $ams_checked_children: 0 },
	{ text: 'H', value: 'h', id: 8,  $ams_order: 8,  $ams_parents_id: [7],              $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: false, checked: false, $ams_checked_children: 0 },
	{ text: 'I', value: 'i', id: 9,  $ams_order: 9,  $ams_parents_id: [7],              $ams_children_nodes: 0, $ams_children_leafs: 2, $ams_level: 1, open: false, $ams_tree_visibility: false, checked: -1,    $ams_checked_children: 0 },
	{ text: 'J', value: 'j', id: 10, $ams_order: 10, $ams_parents_id: [7, 9],           $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 2, open: false, $ams_tree_visibility: false, checked: false, $ams_checked_children: 0 },
	{ text: 'K', value: 'k', id: 11, $ams_order: 11, $ams_parents_id: [7, 9],           $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 2, open: false, $ams_tree_visibility: false, checked: false, $ams_checked_children: 0 },
	{ text: 'L', value: 'l', id: 12, $ams_order: 12, $ams_parents_id: [7],              $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: false, checked: false, $ams_checked_children: 0 },
	{ text: 'M', value: 'm', id: 13, $ams_order: 13, $ams_parents_id: [7],              $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: false, checked: false, $ams_checked_children: 0 },
	{ text: 'N', value: 'n', id: 14, $ams_order: 14, $ams_parents_id: [],               $ams_children_nodes: 3, $ams_children_leafs: 5, $ams_level: 0, open: true,  $ams_tree_visibility: true,  checked: 0,     $ams_checked_children: 1 },
	{ text: 'O', value: 'o', id: 15, $ams_order: 15, $ams_parents_id: [14],             $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: true,  checked: false, $ams_checked_children: 0 },
	{ text: 'P', value: 'p', id: 16, $ams_order: 16, $ams_parents_id: [14],             $ams_children_nodes: 2, $ams_children_leafs: 3, $ams_level: 1, open: true,  $ams_tree_visibility: true,  checked: 0,     $ams_checked_children: 1 },
	{ text: 'Q', value: 'q', id: 17, $ams_order: 17, $ams_parents_id: [14, 16],         $ams_children_nodes: 1, $ams_children_leafs: 2, $ams_level: 2, open: true,  $ams_tree_visibility: true,  checked: 0,     $ams_checked_children: 1 },
	{ text: 'R', value: 'r', id: 18, $ams_order: 18, $ams_parents_id: [14, 16, 17],     $ams_children_nodes: 0, $ams_children_leafs: 1, $ams_level: 3, open: false, $ams_tree_visibility: true,  checked: 1,     $ams_checked_children: 1 },
	{ text: 'S', value: 's', id: 19, $ams_order: 19, $ams_parents_id: [14, 16, 17, 18], $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 4, open: false, $ams_tree_visibility: false, checked: true,  $ams_checked_children: 0 },
	{ text: 'T', value: 't', id: 20, $ams_order: 20, $ams_parents_id: [14, 16, 17],     $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 3, open: false, $ams_tree_visibility: true,  checked: false, $ams_checked_children: 0 },
	{ text: 'U', value: 'u', id: 21, $ams_order: 21, $ams_parents_id: [14, 16],         $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 2, open: false, $ams_tree_visibility: true,  checked: false, $ams_checked_children: 0 },
	{ text: 'V', value: 'v', id: 22, $ams_order: 22, $ams_parents_id: [14],             $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: true,  checked: false, $ams_checked_children: 0 },
	{ text: 'W', value: 'w', id: 23, $ams_order: 23, $ams_parents_id: [],               $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 0, open: false, $ams_tree_visibility: true,  checked: false, $ams_checked_children: 0 },
	{ text: 'X', value: 'x', id: 24, $ams_order: 24, $ams_parents_id: [],               $ams_children_nodes: 0, $ams_children_leafs: 2, $ams_level: 0, open: false, $ams_tree_visibility: true,  checked: 1,     $ams_checked_children: 2 },
	{ text: 'Y', value: 'y', id: 25, $ams_order: 25, $ams_parents_id: [24],             $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: false, checked: true,  $ams_checked_children: 0 },
	{ text: 'Z', value: 'z', id: 26, $ams_order: 26, $ams_parents_id: [24],             $ams_children_nodes: 0, $ams_children_leafs: 0, $ams_level: 1, open: false, $ams_tree_visibility: false, checked: true,  $ams_checked_children: 0 }
];
